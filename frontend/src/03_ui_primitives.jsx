...
function Badge({ kind='neutral', children, dot=false, style }) {
...
function Sparkline({ values, color='var(--brand-accent)', height=28, width=120, fill=true }) {
...
// Bar chart (simple)
function BarChart({ data, accessor='count', labels='status', height=180, color='var(--brand-primary)', secondaryColor='var(--brand-accent)' }) {
...
function DualBar({ data, accessorA, accessorB, labelAccessor, labelA, labelB, height=180, colorA='var(--brand-primary)', colorB='var(--brand-accent)' }) {
...
function StateTimeline({ currentStatus, lang='es', dates={} }) {
...
Object.assign(window, {
  Badge, StatusBadge, CreditDot, Progress, Sparkline, BarChart, DualBar,
  StateTimeline, CreditBar, Seg, CountryFlag,
});
