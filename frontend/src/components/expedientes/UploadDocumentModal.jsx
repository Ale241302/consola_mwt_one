...
const DOCUMENT_KINDS = [
  ...
  { id: "BL",        es: "AWB / BL",              en: "AWB / BL",
    hint_es: "Conocimiento de embarque aéreo o marítimo.",
    hint_en: "Air/sea waybill or bill of lading." },
  { id: "NFE",       es: "NF-e",                  en: "NF-e",
    hint_es: "Nota fiscal electrónica (Brasil).",
    hint_en: "Brazilian electronic invoice." },
  { id: "DUE",       es: "DUE",                   en: "DUE",
    hint_es: "Declaração Única de Exportação (Brasil).",
    hint_en: "Brazilian export declaration (DUE)." },
  { id: "DUA",       es: "DUA",                   en: "DUA",
    hint_es: "Declaración Única Aduanera (CR).",
    hint_en: "Customs declaration (DUA)." },
  { id: "CO",        es: "Certificado de origen", en: "Certificate of origin",
    hint_es: "Certificado de origen.",
    hint_en: "Certificate of origin." },
  { id: "PACKING",   es: "Packing list",          en: "Packing list",
    hint_es: "Lista de empaque / romaneio.",
    hint_en: "Packing list." },
  { id: "ROMANEIO",  es: "Romaneio",              en: "Romaneio",
    hint_es: "Romaneio (Brasil).",
    hint_en: "Romaneio (Brazil)." },
  { id: "SEGURO",    es: "Seguro",                en: "Insurance",
    hint_es: "Póliza / nota de seguro.",
    hint_en: "Insurance policy / note." },
  { id: "BOOKING",   es: "Booking",               en: "Booking",
    hint_es: "Reserva / booking de flete.",
    hint_en: "Freight booking." },
  { id: "COSTO_LOGISTICO", es: "Costo logístico", en: "Logistic cost",
    hint_es: "Costos de flete / aduana / agente.",
    hint_en: "Freight / customs / agent cost." },
  { id: "PAGO",      es: "Pago",                  en: "Payment",
    hint_es: "Comprobante de pago / transferencia.",
    hint_en: "Payment / transfer proof." },
  { id: "RECLAMO",   es: "Reclamo",               en: "Claim",
    hint_es: "Reclamo o nota de crédito.",
    hint_en: "Claim or credit note." },
