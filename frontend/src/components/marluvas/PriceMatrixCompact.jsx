...
//
// Matriz 12 bandas × 4 plazos para UN solo SKU. Versión "compact":
// sin columnas SKU/Ref a la izquierda (porque el caller ya identifica
// el SKU en su propio header). Pensada para usarse dentro de cards
// por cliente en el detalle del producto.
//
...
//   · readOnly?          si true, celdas no editables (display only)
            ...
            {BANDAS_MARLUVAS.map((b) => {
              ...
              return (
                <th key={b.id} colSpan={4} style={{
                  ...
                  <div style={{ font: "700 10px/1.2 var(--font-body)" }}>{b.rango}</div>
                  <div style={{
                    font: "500 8.5px/1 var(--font-mono, ui-monospace)",
            ...
            {BANDAS_MARLUVAS.flatMap((b) => {
              ...
              return PLAZOS_MARLUVAS.map((p, pi) => (
                <th key={`${b.id}-${p.dias}`} style={{
                  ...
                  <div style={{ font: "700 9.5px/1 var(--font-body)" }}>{p.dias}d</div>
                  <div style={{
                    font: `${pi === 0 ? 600 : 500} 8px/1 var(--font-body)`,
