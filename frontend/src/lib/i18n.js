...
export const STRINGS = {
  es: {
    ...
    financiero: 'Financiero', transfers: 'Movimientos', nodos: 'Nodos', clientes: 'Clientes',
    ...
    pay_understood: 'Entendido',
    pay_payload_captured: 'PAYLOAD CAPTURADO POR EL DRAWER',
    // Wizard
  ...
  en: {
    ...
    pay_understood: 'Got it',
    pay_payload_captured: 'PAYLOAD CAPTURED BY THE DRAWER',
