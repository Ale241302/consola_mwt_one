...
commission_amount = base × commission_rate
                 -- decisión CEO 2026-07-29: regla DUAL según operador.
                 --   operado por MWT     → base = delta_total (margen de reventa)
                 --   operado por cliente → base = total_client (comisión por operación;
                 --     ahí unit_price_client = unit_price_mwt y delta = 0)
