            ...
            with transaction.atomic():
                with connection.cursor() as c:
                    ...
                    if split_ids:
                        ...
                        # El split se dispara ÚNICAMENTE cuando cambia el
                        # cliente, cuando se mueve solo un subconjunto de líneas
                        # o cuando se parte alguna cantidad. Un cambio de
                        # operador con TODAS las líneas y las mismas cantidades
                        # es una actualización in-place del expediente original,
                        # no un split.
