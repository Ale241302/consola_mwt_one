...
urlpatterns = [
    ...
    path("api/",           include("apps.tareas.urls")),           # /api/tareas/* + /api/tareas/catalogo/ [Etapa 2 · agenda + mesa de trabajo]
    path("api/",           include("apps.correo.urls")),           # /api/correo/* [Etapa 3 · bandeja + contactos + envio]
]
